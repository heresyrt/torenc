...
import Features from "@/components/BuField4/index";
              ...
              <div>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    - 옹벽 자체의 무게와 토압의 합력이 바닥면에 작용하여 옹벽자체의 중량과 무게로 흙이 흘러내리는 것을 막을 수 있도록 만든 옹벽 구조물<br/>
                    - 조립식 공법으로 공종이 단순하여 시공속도가 빠름.<br/>
                    - 그리드 없이 높이 5M까지 시공이 가능함.<br/>
                    - 자연석과 같은 질감과 색상으로 경관이 매우 우수함
                  </p>
                    ...
                    <div className="-mx-4 flex flex-wrap">
                      <div className="w-full px-4">
                        <div className="relative mx-auto aspect-25/10 max-w-[1600px]">
                          <Image
                            src="/images/buField/buField4_desc_w.png"
                            alt="about-image"
                            fill
                            className="mx-auto max-w-full drop-shadow-three dark:hidden dark:drop-shadow-none lg:mr-0"
                          />
                          <Image
                            src="/images/buField/buField4_desc.png"
                            alt="about-image"
                            fill
