import SingleBlog from "@/components/certification/SingleBlog";
import blogData from "@/components/certification/constructionData";
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="인증현황"
        description="더오름이앤씨의 인증현황을 확인하세요."
      />
