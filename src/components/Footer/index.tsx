            ...
            <div className="w-full px-3 md:w-1/2 lg:w-3/12 xl:w-4/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Tel : 031-869-3453<br />
                  Fax : 031-869-3454<br />
                  Email : <a href="mailto:torenc3453@naver.com">torenc3453@naver.com</a>
                </p>
                <div className="flex items-center">
                  <a href="#" aria-label="social-link" target="_blank" rel="noopener noreferrer" className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"                  >
                  ...
                  <a href="#" aria-label="social-link" target="_blank" rel="noopener noreferrer" className="text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
